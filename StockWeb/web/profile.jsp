        ...
        <div class="inner-content">
            ...
            <div class="outter-wp">
                ...
                <div class="graph-visual tables-main">
                    <h3 class="inner-tittle two">user profile</h3>
                    <div class="graph">
                        <form action="ProfileServlet?save=true" method="post">
                            <li>click right text to modify</li>
                            ...
                            <div class="tables">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="inputinfo" width="12%"><%=request.getSession().getAttribute("UserNameSession")%></td>
                                    </tr>
                                    <tr>
                                        <th style="text-align: center; width: 10%">password</th>
                                        <td class="inputinfo" width="12%"><input name="password"
                                                                                 id="password"
                                                                                 style="width: 90%; color: grey; background-color: transparent; border: 0px"
                                                                                 value="<%=request.getSession().getAttribute("profile_password")%>"
                                                                                 maxlength="45" type="text"></td>
                                    </tr>
                                    <tr>
                                        <th style="text-align: center; width: 10%">address</th>
                                        <td class="inputinfo" width="12%"><input name="address"
                                                                                 id="address"
                                                                                 style="width: 90%; color: grey; background-color: transparent; border: 0px"
                                                                                 value="<%=request.getSession().getAttribute("profile_address")%>"
                                                                                 maxlength="45" type="text"></td>
                                    </tr>
                                    <tr>
                                        <th style="text-align: center; width: 10%">email</th>
                                        <td class="inputinfo" width="12%"><input name="email"
                                                                                 id="email"
                                                                                 style="width: 90%; color: grey; background-color: transparent; border: 0px"
                                                                                 value="<%=request.getSession().getAttribute("profile_email")%>"
                                                                                 maxlength="15" type="text"></td>
                                    </tr>
                                    <tr>
                                        <th style="text-align: center; width: 10%">balance</th>
                                        <td class="inputinfo" width="12%"><%=request.getSession().getAttribute("profile_balance")%></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
