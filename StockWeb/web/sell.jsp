...
<%@ page import="main.java.bean.Buy" %><%--
            ...
            <div class="outter-wp">
                ...
                <div class="graph-visual tables-main">
                    ...
                    <%
                        ...
                        List<Buy> buy_list = (List<Buy>) session.getAttribute("buy_list");
                    %>

                    <form action="SellServlet" method="post" style="display: inline;">
                        <div class="graph">
                            ...
                            <div class="tables">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align: center;background:#f1fafb" colspan="2">Input Quantity</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <%
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="text-align: center;"><%=buy_list.get(i).getQuantity()%></td>
                                        <td class="inputinfo">
                                            <input name="quantity<%=i+1%>" style="color: grey; background-color: transparent; border: 0px"
                                                   value="0"
                            ...
                            <div class="tables">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align: center;background:#f1fafb" colspan="2">Quantity</th>
                                        <th style="text-align: center;background:#f1fafb" colspan="2">Input Quantity</th>
                                        <th style="text-align: center;background:#f1fafb" colspan="2">Input Wait Time</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <%
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="text-align: center;"><%=list.get(i).getPrice()%></td>
                                        <td colspan="2" style="text-align: center;"><%=buy_list.get(i).getQuantity()%></td>
                                        <td colspan="2" class="inputinfo">
                                            <input name="quantity<%=i+1%>" style="color: grey; background-color: transparent; border: 0px"
                                                   value="0"
                                                   maxlength="45" type="text">
                                        </td>
                                        <td colspan="2 " class="inputinfo">
                                            <input name="time<%=i+1%>" style="color: grey; background-color: transparent; border: 0px"
                                                   value="30"
                                                   maxlength="45" type="text">
                                        </td>
                                    </tr>
