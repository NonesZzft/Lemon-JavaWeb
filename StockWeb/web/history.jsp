                            ...
                            %>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <form action="HistoryServlet?type=name" method="post">
                                            <th style="text-align: center;background:#f1fafb" colspan="2"><input name="name" type="submit" value="Stock Name"></th>
                                        </form>
                                        <form action="HistoryServlet?type=price" method="post">
                                            <th style="text-align: center;background:#f1fafb" colspan="2"><input name="price" type="submit" value="price"></th>
                                        </form>
                                        <form action="HistoryServlet?type=quantity" method="post">
                                            <th style="text-align: center;background:#f1fafb" colspan="2"><input name="quantity" type="submit" value="quantity"></th>
                                        </form>
                                        <th style="text-align: center;background:#f1fafb" colspan="2">Sell</th>
                                    </tr>
                                    </thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="text-align: center;"><%=list.get(i).getS_name()%></td>
                                            ...
                                            <td colspan="2" style="text-align: center;">
                                                <input type="checkbox" name="sell" value="<%=list.get(i).getS_name()%>">
                                            </td>
                                        </tr>
                                        <%
                                            }
